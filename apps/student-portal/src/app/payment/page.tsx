...
export default function PaymentPage() {
  ...
  return (
    ...
    >
      <div className="mt-5 rounded-xl border border-white/[0.06] bg-scalex-charcoal-alt p-4">
        ...
        <ul className="mt-4 space-y-2 text-sm text-text-secondary-dark">
      ...
      <p className="mt-3 text-center text-xs text-text-tertiary-dark">
      ...
      <form action="/auth/signout" method="post" className="mt-4 text-center">
        <button
          type="submit"
          className="text-xs text-text-secondary-dark transition-colors hover:text-scalex-red"
        >
